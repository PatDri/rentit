...
function styledstore_scripts() {
	...
	wp_enqueue_style( 'styledstore-google-font-roboto', '//fonts.googleapis.com/css?family=Roboto:400,300,400italic,500,700,700italic,500italic,900|Source+Sans+Pro:100,400,700' );
