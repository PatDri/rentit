    ...
    <div class="col2 evidence">
        <h3><?php printf(esc_html__('%s Premium', 'onepage'), $theme_data->Name); ?></h3>
           <p>
            ...
            <a href="<?php echo esc_url( 'https://www.iograficathemes.com/downloads/onepage' ); ?>" target="_blank" class="button-upgrade">
     ...
     <div class="col2 omega">
        ...
        <p>
            <a href="<?php echo esc_url( 'https://www.iograficathemes.com/documentation/'. $theme_data->get( 'TextDomain' ) .'-premium/' ); ?>" target="_blank" class="button button-secondary"><?php esc_html_e('View Documentation', 'onepage'); ?></a>
        </p>
